            ...
            <div className="max-w-5xl mx-auto space-y-8 sm:space-y-10">
              ...
              <div className="text-center space-y-2">
                <Button
                  ...
                  className="w-full max-w-2xl text-xl sm:text-2xl font-black rounded-2xl bg-gradient-to-r from-[#FFD700] to-[#FFB700] border-4 border-[#FFD700]/50 shadow-2xl shadow-[#FFD700]/60 text-black hover:shadow-[#FFD700]/80 hover:scale-105 transition-all duration-300"
                  data-testid="button-buy-now"
                >
                  <ShoppingCart className="w-6 h-6 sm:w-7 sm:h-7 mr-3" />
                  COMPRAR AGORA POR 12x R$ 20,37
                </Button>
                <p className="text-xs sm:text-sm text-[#FFD700] font-semibold animate-pulse flex items-center justify-center gap-1">
                  <Zap className="w-3 h-3 sm:w-4 sm:h-4 fill-[#FFD700]" />
