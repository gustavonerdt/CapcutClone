        ...
        <Card className="max-w-md w-full p-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button 
              ...
              className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-[#FFD700] to-[#FFB700] border-2 border-[#FFD700]/50 shadow-xl shadow-[#FFD700]/60 text-black hover:shadow-[#FFD700]/80 hover:scale-105 transition-all duration-300"
